...
import static io.github.racoondog.multiinstance.MultiInstance.LOG;
...
public final class InstanceBuilder {
    ...
    public Process start() {
        ...
        try {
            ...
            if (verbose) LOG.info("Instance started with PID {}.", process.pid());

            return process;
        } catch (IOException e) {
            if (verbose) e.printStackTrace();
            LOG.warn("Could not start instance...");
            return null;
        }
    }
}
